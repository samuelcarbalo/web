  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-8">
      <div className="page-container">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Mis Aplicaciones</h1>
              ...
              <div key={application.id} className="card hover:shadow-2xl transition-shadow">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-start gap-2 p-3 bg-gray-50 dark:bg-gray-900/50 rounded-3xl">
