          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-gray-200/80 dark:border-gray-800/80 p-6 md:p-8">
            ...
            <div className="text-gray-600 dark:text-gray-400 space-y-3 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 pl-2">
                <li>
                  <strong className="text-gray-800 dark:text-gray-100">Datos del Perfil:</strong> Nombre completo, dirección de correo electrónico, número de teléfono, foto de perfil y tipo de usuario (Persona o Empresa).
                </li>
                <li>
