...
const TournamentsList: React.FC = () => {
  ...
  const getStatusColor = (status: string) => {
    const colors: Record<string, string> = {
      upcoming: 'bg-violet-50 dark:bg-violet-950/30 text-blue-700 border-violet-200 dark:border-violet-800',
      ongoing: 'bg-green-50 dark:bg-green-950/40 text-green-700 dark:text-green-300 border-green-200 dark:border-green-800',
      active: 'bg-green-50 dark:bg-green-950/40 text-green-700 dark:text-green-300 border-green-200 dark:border-green-800',
      registration: 'bg-violet-50 dark:bg-violet-950/30 text-blue-700 dark:text-violet-300 border-violet-200 dark:border-violet-800',
      draft: 'bg-gray-50 dark:bg-gray-900/50 text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-800',
      completed: 'bg-gray-50 dark:bg-gray-900/50 text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-800',
      finished: 'bg-gray-50 dark:bg-gray-900/50 text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-800',
      cancelled: 'bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-300 border-red-200 dark:border-red-800',
    };
    return colors[status] || 'bg-gray-50 dark:bg-gray-900/50 text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-800';
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950/50">
      ...
      <div className="relative bg-gray-900 overflow-hidden">
        ...
        {/* Bottom gradient */}
        <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-gray-50/50 dark:from-gray-950 to-transparent" />
      </div>
      ...
      <div className="page-container py-8">
        ...
        {showMyTournamentsOption && !isMatchesTab && (
          <div className="flex justify-start mb-6">
            <div className="bg-white dark:bg-gray-900 p-1.5 rounded-3xl border border-gray-200/80 dark:border-gray-800/80 flex gap-1 shadow-sm">
              <button
                onClick={() => setViewMode('all')}
                className={`px-5 py-2.5 text-sm font-bold rounded-3xl transition-all ${
                  viewMode === 'all'
                    ? 'bg-green-600 text-white shadow-md shadow-green-600/10'
                    : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white hover:bg-gray-50 dark:bg-gray-900/50'
                }`}
              >
                Todos los torneos
              </button>
          ...
          <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
            {tabs.map((tab) => (
              <button
                ...
                className={`
                  flex items-center gap-2 px-4 py-2.5 rounded-3xl text-sm font-semibold whitespace-nowrap transition-all
                  ${activeTab === tab.value
                    ? 'bg-gray-900 text-white shadow-lg shadow-gray-900/20'
                    : 'bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600'
                  }
                `}
              >
          ...
          {!isMatchesTab && (
            <div className="relative flex-shrink-0">
              ...
              <input
                ...
                className="pl-9 pr-4 py-2.5 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-700 rounded-3xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 w-full md:w-64 transition-all placeholder:text-gray-400 dark:placeholder:text-gray-500"
              />
            </div>
          )}
        </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-gray-200/80 dark:border-gray-800/80 p-4 mb-6">
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="p-2.5 rounded-3xl hover:bg-gray-100 dark:bg-gray-800 text-gray-500 hover:text-gray-900 dark:text-white transition-all"
                ...
                <div className="flex-1 text-center">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <p className={`text-lg font-bold capitalize ${isToday ? 'text-green-600' : 'text-gray-900 dark:text-white'}`}>
                      {dayLabel}
                    </p>
                  </div>
              ...
              <div className="flex justify-center gap-2 mt-3 pt-3 border-t border-gray-100 dark:border-gray-800">
                {[-2, -1, 0, 1, 2].map((dayOffset) => {
                  ...
                  return (
                    <button
                      ...
                      className={`
                        px-3 py-1.5 rounded-3xl text-xs font-medium transition-all
                        ${isSelected
                          ? 'bg-gray-900 text-white shadow-sm'
                          : 'text-gray-500 hover:bg-gray-100 dark:bg-gray-800'
                        }
                      `}
                    >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                <button
                  ...
                  className={`
                    px-3.5 py-1.5 rounded-3xl text-xs font-semibold whitespace-nowrap transition-all border
                    ${selectedStatus === ''
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
                {filteredTournaments?.map((tournament: any) => (
                  <Link
                    ...
                    className="bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-gray-200/80 dark:border-gray-800/80 overflow-hidden hover:shadow-2xl hover:border-gray-300 dark:hover:border-gray-600 transition-all group flex flex-col"
                  >
                    {/* Banner / Header */}
                    <div className="h-36 relative overflow-hidden">
                      {tournament.banner ? (
                        ...
                        <div className={`w-full h-full ${sportTypeColors[tournament.sport_type as SportType] || 'bg-gradient-to-r from-violet-600 to-indigo-600'} flex items-center justify-center`}>
                      ...
                      <div className="absolute top-3 left-3 flex gap-2">
                        <span className="bg-white/90 backdrop-blur-sm text-gray-800 dark:text-gray-100 text-xs font-bold px-2.5 py-1 rounded-3xl shadow-sm">
                        {getSportIcon(tournament.sport_type as SportType)}
                        </span>
                      </div>

                      <div className="absolute top-3 right-3">
                        <span className={`px-2.5 py-1 text-xs font-bold rounded-3xl border shadow-sm backdrop-blur-sm ${getStatusColor(tournament.status)}`}>
                      ...
                      {tournament.logo && (
                        <div className="absolute -bottom-5 right-4">
                          <img
                            src={tournament.logo}
                            alt=""
                            className="w-14 h-14 rounded-3xl object-cover border-3 border-white dark:border-gray-800 shadow-lg bg-white dark:bg-gray-800"
                          />
                        </div>
                      )}
                    </div>
                    ...
                    <div className="p-5 pt-6 flex-1 flex flex-col">
                      <h3 className="font-bold text-gray-900 dark:text-white group-hover:text-green-700 dark:group-hover:text-green-400 transition-colors text-lg leading-tight line-clamp-2">
                        {tournament.name}
                      </h3>
