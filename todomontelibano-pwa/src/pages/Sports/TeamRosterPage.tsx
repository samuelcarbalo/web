...
const TeamRosterPage: React.FC = () => {
  ...
  // Actualizar formData cuando tournament y teamId estén disponibles
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Formulario - Solo visible si myTeam existe */}
          {myTeam ? (
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-6">
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">No eres entrenador de ningún equipo</p>
                  <p className="text-sm text-gray-400 mt-1">No puedes gestionar jugadores</p>
                </div>
              </div>
            </div>
          )}
