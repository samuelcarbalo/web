...
const Home: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Eventos",
      description:
        "Descubre eventos sociales, culturales y de networking en la región.",
      color: "bg-purple-500",
  ...
  const features = [
    {
      icon: Users,
      text: "Multi-tenant: Una plataforma, múltiples organizaciones",
    },
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-b from-blue-900 via-blue-800 to-sky-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
              CordobaTech conecta a la comunidad con múltiples servicios en una
              sola plataforma
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service) => (
              ...
              >
                ...
                <div
                  className={`w-14 h-14 ${service.color} ${service.hoverColor} rounded-xl flex items-center justify-center mb-4 transition-transform group-hover:scale-110 group-hover:rotate-3`}
                >
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Nuestra plataforma está diseñada pensando en las necesidades de
                la comunidad de CordobaTech, ofreciendo una experiencia
                unificada para todos los servicios.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {features.map((feature, idx) => (
                  ...
                  >
                    ...
                    <span className="text-gray-700 text-sm leading-tight pt-2">
                      {feature.text}
                    </span>
                  </div>
                ))}
                ...
                <div className="absolute inset-0 flex items-center justify-center p-8">
                  <div className="w-full max-w-sm bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-6 shadow-2xl">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        <p className="text-white font-semibold">CordobaTech</p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="text-center">
            ...
            <p className="text-primary-100 text-lg mb-8 max-w-2xl mx-auto">
              Únete a la comunidad de CordobaTech y descubre todas las
