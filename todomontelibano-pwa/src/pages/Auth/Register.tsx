          ...
          <div className="flex items-center justify-between">
            {steps.map((s, idx) => (
              <div key={s.number} className="flex items-center">
                ...
                <span
                  className={`ml-2 text-sm font-medium ${step >= s.number ? "text-gray-900" : "text-gray-500"}`}
                >
                  {s.title}
                </span>
                {idx < steps.length - 1 && (
                  <div
                    className={`w-12 h-0.5 mx-4 ${step > s.number ? "bg-primary-600" : "bg-gray-200"}`}
                  />
                )}
              </div>
            ))}
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    >
                      <div className="flex flex-col items-center">
                        <User
                          className={`w-8 h-8 mb-2 ${userType === "person" ? "text-primary-600" : "text-gray-400"}`}
                        />
                    ...
                    >
                      <div className="flex flex-col items-center">
                        <Building2
                          className={`w-8 h-8 mb-2 ${userType === "company" ? "text-primary-600" : "text-gray-400"}`}
                        />
                        <span className="block text-sm font-medium text-gray-900">
                          Empresa
                        </span>
          ...
          {register.isError && (
            <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg">
              <p className="text-sm text-red-600">
                Error al crear la cuenta. Verifica que el email no esté
                registrado.
              </p>
            </div>
          )}
